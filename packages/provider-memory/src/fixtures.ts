    ...
    children: [
      {
        ...
        author: 'Dana Whitfield',
        agoMinutes: 4 * HOUR,
        flags: ['open', 'unread', 'review-requested'],
        summary: 'Ready for review; review requested from you.',
        body:
          'Caps the default listing, adds an opaque cursor, and reports the total when the backend gives one.\n\n' +
          'Files changed:\n' +
          '  packages/core/src/vfs.ts      +64 -12\n' +
          '  packages/core/src/paging.ts   +91 -0\n' +
          '  packages/cli/src/commands/ls.ts  +18 -4\n\n' +
        ...
        meta: {
          ...
          deletions: 16,
          files: 3,
          branch: 'dana/cursor-paging',
          base: 'main',
          reviewers: 'you@contoso.example',
          checks: 'passing',
          url: 'https://example.invalid/contoso/mscomms/pull/14',
        },
      },
      {
        id: 'pr-15',
        title: '#15 Draft: replace the cache with an LRU',
        subtype: 'pull',
        author: 'Priya Raman',
        agoMinutes: 30,
        // Draft on purpose: it is how you check that `merge` correctly declines to appear.
        flags: ['open', 'draft'],
        summary: 'Still a draft, so it should not offer to merge.',
        body: 'Swaps the unbounded map for a bounded LRU. Numbers to follow before this leaves draft.',
        meta: {
          number: 15,
          state: 'open',
          draft: true,
          ...
          base: 'main',
          checks: 'pending',
          url: 'https://example.invalid/contoso/mscomms/pull/15',
        },
      },
      {
        id: 'pr-11',
        title: '#11 Escape right-to-left overrides in listings',
        subtype: 'pull',
        author: 'Tom Okafor',
        agoMinutes: 9 * DAY,
        // Merged on purpose: it is how you check that review verbs correctly disappear.
        flags: ['merged'],
        summary: 'Already merged, so the review verbs are gone.',
        body: 'A subject containing U+202E can make a filename read backwards. Now escaped on the way out.',
        meta: {
          number: 11,
          state: 'merged',
          draft: false,
          ...
          deletions: 3,
          files: 2,
          branch: 'tom/rtl-escape',
          base: 'main',
          checks: 'passing',
          url: 'https://example.invalid/contoso/mscomms/pull/11',
        },
      },
    ],
  },
